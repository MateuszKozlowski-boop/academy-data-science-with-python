...
# to check that the proportion of target remained the same for each sample.

y_train.value_counts(normalize=True)
print('Percentage of classes in the train data:', y_train.value_counts(normalize=True).round(5), sep='\n')
print('Percentage of classes in the test data:', y_test.value_counts(normalize=True).round(5), sep='\n')